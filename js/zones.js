...
export const BOUNDS = { minX: -39.6, maxX: 39.6, minZ: -29.4, maxZ: 37.8 };
...
export function buildColliders() {
    ...
    // Lounge stage + jukebox
    wall(boxes, -3.4, 3.4, -14.6, -12.4, 4.2, 5.4);
